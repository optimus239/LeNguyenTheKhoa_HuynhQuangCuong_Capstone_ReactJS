  ...
  if (isFetching) {
    return (
      <div className="container">
        <div>
          <div className="mt-10 flex text-center ml-[25%] mb-28 sm:mb-28 lg:mb-32 loading-checkout">
            <Skeleton.Button
              className="mr-1"
              shape={buttonShape}
              size={size}
  ...
  return (
    <div className="container mx-auto min-h-screen">
      <div className="grid grid-cols-12">
        <div className="checkout-seat-list col-span-7 xl:col-span-7 lg:col-span-8 md:col-span-9 sm:col-span-12">
          <div className="display-cinema">
            <h3 className="mb-0 text-red-50 text-lg">Màn hình</h3>
          </div>
          <div className="text-center">{renderSeat()}</div>
        </div>
        <div className="checkout-infor col-span-4 xl:col-span-5 lg:col-span-4 md:col-span-3 sm:col-span-12">
          <div>
            <h3 className="text-center text-2xl text-green-500">
              <NumericFormat
                className="text-center total-price-top w-full"
                allowLeadingZeros
                thousandSeparator=","
            ...
            <div className="mt-5 flex justify-center">
              <div className="bg-white divide-y divide-gray-200 seat-types">
                <div className="mr-3">
